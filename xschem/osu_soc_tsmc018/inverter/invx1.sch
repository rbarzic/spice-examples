...
N 180 160 180 200 {lab=#net1}
N 180 130 230 130 {lab=#net1}
N 230 130 230 200 {lab=#net1}
N 180 200 230 200 {lab=#net1}
N 180 80 280 80 {lab=out}
N 40 80 80 80 {lab=in}
N 130 200 180 200 {}
C {pmos4.sym} 160 40 0 0 {name=M1 model=pmos w=5u l=0.18u m=1}
C {nmos4.sym} 160 130 0 0 {name=M2 model=nmos w=5u l=0.18u m=1}
